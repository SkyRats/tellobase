...
class hand_tello_control:
    ...
    def action_to_do(self, fingers, orientation, results): #use the variable results for the hand tracking control
        ...
        if orientation == "left hand":   #Thumb on the left = left hand!
            """
            Mudança abaixo. Adicionei a condiçao do self.tricks para o flip frontal
            """
    ...
    def fingers_position(self, results, orientation):
        ...
        """
        Mudança abaixo. Simplesmente pra deixar o codigo mais limpo
        """
    ...
    def key_control(self):
        ...
        image_name = 0 
        """
        começa a contar o nome dos prints
        """
        ...
        while True:
            ...
            """ Mudança abaixo.
                ...
                tentei passar do pygame pro opencv, espero que tenha dado certo kk
                o botao para descer o drone mudou de lctrl pra c, já que o opencv nao consegue detectar
                apenas o lctrl

                tambem e possivel tirar foto com f (eu espero)
            """
            image_name = 0
            ...
            if key != 255:
                ...
                match key:
                    ...
                    case _:
                        print("Tecla nao corresponte com nenhum comando")
    ...
    def main_interface(self):
        ...
        while telloMode != 0:
            ...
            """
            Mudança abaixo. Só mudei a detecçao de teclas do pygame para o opencv.
            """
